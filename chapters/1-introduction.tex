...
\begin{itemize}
    ...
    \item Chapter \ref{ch:system} (\nameref{ch:system}) gives an overview of the system under consideration in this project, e.g all hardware and software components of the system, as well as an overview of the companies behind the system.
    \item Chapter \ref{ch:related-work} (\nameref{ch:related-work}) lists all identified related work to this thesis. This, among others, includes a security analysis of a system based on similar hardware and partially the same firmware.
    ...
    \item Chapter \ref{ch:pentesting} (\nameref{ch:pentesting}) explains all penetration tests done against the system, potential background information about the attack, the result of the test, as well as a discussion of the consequences and mitigations of them.
