...
\begin{itemize}
    ...
    \item Any \textit{physical attack} on the system. The goal of the system is to prevent physical access to the house. If an attacker has physical access to the system then the goal has already failed, so these types of attacks were not deemed interesting to explore.
\end{itemize}
