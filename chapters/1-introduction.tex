...
\begin{itemize}
    \item Chapter \ref{ch:intro} (this chapter) gives an introduction into the thesis area and research question. Additionally, delimitations of the project are listed.
    ...
    \item Chapter \ref{ch:related-work} lists all identified related work to this thesis. This, among others, includes a security analysis of a system based on the same hardware and partially the same firmware.
    ...
    \item Chapter \ref{ch:pentesting} explains of all penetration tests done against the system, potential background information about the attack, the result of test, as well as a discussion of the consequences and mitigations of them.
    \item TODO...
\end{itemize}
